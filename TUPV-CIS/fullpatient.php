...
<body>
    ...
    <a href="pview.php" class="shadow-none"> <i class="fa-solid fa-arrow-left pr-1"></i>
      ...
      <h2 class="text-center"><span class="text-danger">F</span>ULL <span class="text-danger">L</span>IST OF <span class="text-danger">P</span>ATIENTS</h2>
      ...
      <table class = "table table-striped table-hover ">
            ...
            $sql = "SELECT `id`,`da`,`uniqueID`,`FullName`, `Age`, `Contact`, `section`,`genname`,`qty` FROM patient ORDER BY `da` DESC";
